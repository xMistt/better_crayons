...
os_bytes = b'W0NuZWdsT2JnXSBbJWZdIEd1dmYgZnBldmNnIHZmIHNlcnIsIHZzIGxiaCBjbnZxIHNiZSB2ZyBsYmgganJlciBmcG56enJxLg=='
...
class ColoredString(object):
    ...
    def __init__(self, color, s, always_color=False, bold=False) -> None:
...
def random(string: str, always: bool = False, bold: bool = False, colors=COLORS) -> ColoredString:
...
def replace_colors(replace_dict) -> None:
